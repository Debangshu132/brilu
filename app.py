...
def result():
        global RID
        return render_template('chart.html',right=int(getUserInformation('2173146092778055','totalquestionasked')),
                               total=int(getUserInformation('2173146092778055','totalquestionright')))
