...
def result():
        global RID
        return render_template('chart.html',int(right=getUserInformation(recipient_id,'totalquestionasked')),
                               int(total=getUserInformation(recipient_id,'totalquestionright'))
