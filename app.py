                ...
                if message['message'].get('text'):
                    ...
                    if  message['message'].get('quick_reply'):
                      if message['message']['quick_reply']['payload']=='right':
                        ...
                        updateUsersInformation(recipient_id,totalquestionasked=int(getUserInformation(recipient_id,currtopic+'total'))+1)
                        updateUsersInformation(recipient_id,totalquestionright=int(getUserInformation(recipient_id,currtopic+'right'))+1)
