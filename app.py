                ...
                if message['message'].get('text'):
                    ...
                    if  message['message'].get('quick_reply'):
                      if message['message']['quick_reply']['payload']=='right':
                        ...
                        updateUsersInformation(recipient_id,str(currtopic)+'total'=int(getUserInformation(recipient_id,currtopic+'total'))+1)
                        updateUsersInformation(recipient_id,str(currtopic)+'right'=int(getUserInformation(recipient_id,currtopic+'right'))+1)
